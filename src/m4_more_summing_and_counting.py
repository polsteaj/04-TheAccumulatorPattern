...
import math as mth
import builtins  # Never necessary, but here for pedagogi
...
def run_test_factorial():
    ...
    print('Test 5 expected (from known):', answer_from_by_hand)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 0
    answer = count_cosines_from(5, 9, 1.0)
    ...
    # Test 6:
    expected = 1
    answer = count_cosines_from(3, 4, -.7)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.2361  # This is APPROXIMATELY the correct answer.
